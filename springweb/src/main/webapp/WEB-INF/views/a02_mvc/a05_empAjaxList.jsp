	...
	$(document).ready(function(){
		...
		$("[name=ename], [name=job]").keyup(function() {
			if(event.keyCode==13) { //enter키를 입력시
				...
				//ajax 처리를 통해서 controller 호출 후, 데이터 리스트 처리
				$.ajax({
					url:"${path}/empAjax1.do",
					type:"get",
					...
					success:function(data) {
					    ...
					    $.each(empList, function(idx, emp){
					    	html += "<tr><td>"+emp.empno+"</td><td>"+emp.ename+"</td><td>"+emp.job+"</td><td>"+emp.sal+"</td><td>"+emp.deptno+"</td></tr>";
					    });
					    $("tbody").html(html);
					},
					error:function(err) {
...
<div class="container">
	<form id="frm01" class="form-inline"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    ...
	    <input class="form-control mr-sm-2" placeholder="부서명" name="job"/>
 	</nav>
	</form>
