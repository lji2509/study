...
public class A01_ObjectStart {
	...
	public static void main(String[] args) {
		...
		2. 객체 : 선언된 클래스를 아래의 형식으로 main()메서드가 있는 곳에서 생성자를 통해 생성할 수 있다.
		...
		*/
		Car c1 = new Car();
		Car c2 = new Car();
		System.out.println("heap영역의 주소값 확인 : " + c1);
		System.out.println("heap영역의 주소값 확인 : " + c2);
		/*
		# 객체의 메모리 사용
		...
		*/
		...
		//c1.name : 객체가 있는 heap영역의 주소를 찾아가서, 해당 객체의 필드값(name)으로 호출
		System.out.println(c1.name);
		
		Bus b1 = new Bus();
		Bus b2 = new Bus();
		System.out.println("heap영역의 주소값 확인 : " + b1);
		System.out.println("heap영역의 주소값 확인 : " + b2);
