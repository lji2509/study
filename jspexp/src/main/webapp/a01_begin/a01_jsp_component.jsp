...
<%-- jstl을 통한 변수 선언
pageContext.request.contextPath : 프로젝트명을 context경로로 변수 path로 지정하여, 절대경로로 모든 자원들을 활용할 수 있게 한다.
...
<body>
	...
	%>
	<%
	//scriptlet : 선언된 변수, 또는 지역변수 선언, 객체 생성/조건/반복문 처리 등
	...
	%>
	<h3>결과값 <%=tot %></h3>
	<%--expression <%=출력할 변수%> 형식으로 화면에 처리할 내용을 사용한다. --%>
	<table>
